...
<div class="container">
  <div class="row row-cols-1 row-cols-md-2 pt-5">
    ...
    <div class="col-md-8">
      ...
      <hr/>
      <h2>Polo Femme Bagad de Nantes</h2>
      ...
      <ul>
        ...
        <li>Modèle également disponible pour homme</li>
      </ul>
      ...
      <p>Alliant le confort et la commodité, le polo personnalisé pour femme Greenville de Harvest
          saura s'inviter dans l'uniforme de votre équipe.
          Personnalisez-le avec votre logo et laissez vos employés promouvoir votre marque à chaque utilisation.</p>
